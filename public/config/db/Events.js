...
var Events = (function () {
    ...
    Events.prototype.AddCertEvent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.db.query("INSERT INTO events(user_id, msg, datecreatemsg) " +
                            "VALUES (" + this.args.user_id + ", 'Добавил(а) сертификат " + this.args.certname + "', '" + (0, DateStr_1.dateTimeToSQL)(new Date()) + "')")];
                    case 1:
                        _a.sent();
                        return [2];
                }
    ...
    Events.prototype.UpdateCertEvent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.db.query("INSERT INTO events(user_id, msg, datecreatemsg) " +
                            "VALUES (" + this.args.user_id + ", 'Изменил(а) сертификат " + this.args.certname + "', '" + (0, DateStr_1.dateTimeToSQL)(new Date()) + "')")];
                    case 1:
                        _a.sent();
                        return [2];
                }
