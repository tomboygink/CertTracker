...
exports.verif_token = verif_token;
...
function add_token(data, res) {
    var token = (0, jwt_1.generateToken)(data[0]);
    var jwtExpires = config_json_1.default.code_time.time;
    var cookieMaxAge = (0, ms_1.default)(jwtExpires);
