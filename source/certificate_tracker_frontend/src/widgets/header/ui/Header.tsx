...
export const Header = () => {
	return (
		<>
			<MobileHeader />
			<div className="hidden xl:block relative h-[100vh] min-w-[287px] border-r-1 border-[#e0dfdf]">
			...
			<div className="hidden xl:block absolute top-0 right-0 w-full h-[65px] pl-[287px] border-b-1 border-[#e0dfdf]">
