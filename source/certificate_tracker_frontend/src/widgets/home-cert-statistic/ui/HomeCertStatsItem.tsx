...
export const HomeCertStatsItem: FC<HomeCertStatsItemProps> = ({
	...
	return (
		<div className="flex flex-col gap-[6px] w-full sm:gap-[6px] md:gap-[6px] lg:gap-[16px] xl:gap-[16px] 2xl:gap-[16px]">
			<div className="flex items-center gap-[12px] w-full xl:flex-col xl:items-start 2xl:flex-row 2xl:items-center">
				<div
				...
				></div>
				<p className="font-medium text-[14px] text-[#202020] leading-[20px] sm:text-[14px] md:text-[20px] lg:text-[20px] xl:text-[20px] 2xl:text-[20px]">
					{title}
				</p>
			</div>
