	...
	switch (body.cmd) {
		...
		case 'Auth': {
			...
			if (!data || data.length === 0) {
				return buildResponse(body.cmd, null, 'Ошибка авторизации')
			}
		...
		case 'GetUser': {
			...
			if (!token) {
				return buildResponse(body.cmd, null, 'no_token')
			}
			try {
		...
		case 'AddUser': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка добавления пользователя'
			)
		}
		...
		case 'ChangeUser': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка обновления данных пользователя'
			)
		}
		//Все пользовтаели
		case 'AllUsers': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения пользователей'
			)
		}
		...
		case 'AllAccess': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения уровней доступа'
			)
		}
		...
		case 'AddWorkPosition': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка добавления должности'
			)
		}
		//Изменение должности
		case 'ChangeWorkPosition': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка изменения должности'
			)
		}
		//Все должности
		case 'AllWorkPosition': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения должностей'
			)
		}
		...
		case 'AddDept': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка добавления отдела'
			)
		}
		//Изменение отдела
		case 'ChangeDept': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка изменения отдела'
			)
		}
		//Все отделы
		case 'AllDept': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения отделов'
			)
		}
		...
		case 'AddCategoryCert': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка добавления категории'
			)
		}
		//Изменение категории
		case 'ChangeCategoryCert': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка изменения категории'
			)
		}
		//Все категории
		case 'AllCategoryCert': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения категорий'
			)
		}
		...
		case 'AllStatusCert': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения статусов сертификата'
			)
		}
		...
		case 'AddCert': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка добавления сертификата'
			)
		}
		...
		case 'ChangeCert': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка изменения сертификата'
			)
		}
		...
		case 'AllCert': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения сертификатов'
			)
		}
		...
		case 'Docs': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения документа'
			)
		}
		...
		case 'AllEvents': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения событий'
			)
		}
		...
		case 'AllNotif': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка получения уведомлений'
			)
		}
		...
		case 'NotifRead': {
			...
			return buildResponse(
				body.cmd,
				data,
				data ? null : 'Ошибка прочтения уведомления'
			)
		}
		...
		default: {
			return buildResponse(
				body.cmd,
				data,
				data ? null : `Команда "${body.cmd}" не распознана`
			)
		}
	}
}
